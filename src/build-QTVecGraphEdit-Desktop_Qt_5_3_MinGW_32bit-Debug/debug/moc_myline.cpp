...
#include "../../QTVecGraphEdit/myline.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyLine_t, stringdata) + ofs \
...
const QMetaObject MyLine::staticMetaObject = {
    { &QGraphicsLineItem::staticMetaObject, qt_meta_stringdata_MyLine.data,
      qt_meta_data_MyLine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyLine.stringdata))
